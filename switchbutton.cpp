...
SwitchButton::SwitchButton(QWidget *parent): QWidget(parent)
{
    ...
    bgColorOff = QColor("#ef4136");
    bgColorOn = QColor("#1d953f");
    sliderColorOff = QColor("#fffef9");
    sliderColorOn = QColor("#fffef9");
...
void SwitchButton::setPress(bool state)
{
	if (checked == state)
		return;
...
void SwitchButton::setIsOper(bool isOper)
{
	this->isOper = isOper;
	update();
}
